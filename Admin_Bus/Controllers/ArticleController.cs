...
//        public ArticleController(ArticleDbContext context, IWebHostEnvironment env)
//        {
//            _context = context;
//            _env = env;
//        }
...
//                existingArticle.NoiDung = updatedArticle.NoiDung;
...
//                    {
//                        anh.ID_BaiViet = id; // Gán ID_BaiViet cho ảnh mới
...
//                .Include(a => a.AnhBaiViets) // Load danh sách ảnh trước khi xóa
//                .FirstOrDefaultAsync(a => a.ID_BaiViet == id);
...
//                return Ok("Bài viết đã bị xóa.");
//            }
//            catch (Exception ex)
//            {
//                return StatusCode(500, $"Lỗi khi xóa bài viết: {ex.InnerException?.Message ?? ex.Message}");
//            }
//        }
